...
def getSettings():
  ...
  parser.add_option("--annotable",dest="annotable",help="Custom table for annotation.");
...
def runQueries(chr,start,stop,snpset,build,db_file):
  ...
  results['generic'] = runQuery(generic_in_region,[db,SQLITE_GENERIC,chr,start,stop,build]);
